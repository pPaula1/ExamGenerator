...
from workspace_latex import render_workspace_blocks
...
def render_task(task_file: Path, task: dict[str, Any], out_dir: Path) -> str:
    ...
    page_break_before = bool((task.get("render") or {}).get("page_break_before", False))
    ...
    if parts:
        ...
        for part in parts:
            ...
            if part_workspace:
                ...
                lines.append(render_workspace_blocks(part_workspace, latex_escape))
        ...
        if task_workspace:
            ...
            lines.append(render_workspace_blocks(task_workspace, latex_escape))
